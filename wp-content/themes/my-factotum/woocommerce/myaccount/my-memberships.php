		...
		<thead>
			<tr>
				...
				$my_memberships_columns = apply_filters( 'wc_memberships_my_memberships_column_names', array(
					'membership-plan'       => _x( 'Produit', 'Membership plan', 'woocommerce-memberships' ),
					'membership-start-date' => _x( 'Début', 'Membership start date', 'woocommerce-memberships' ),
					'membership-end-date'   => _x( 'Fin', 'Membership end date', 'woocommerce-memberships' ),
					'membership-status'     => _x( 'Statut', 'Membership status', 'woocommerce-memberships' ),
					'membership-actions'    => '&nbsp;',
				), $user_id );
